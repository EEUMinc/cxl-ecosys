...
from cxl_ecosys.cxl.mmio.component_register.memcache_register.capability import (
    CxlCapabilityHeaderStructure,
    CxlCapabilityHeaderStructureOptions,
)
from cxl_ecosys.cxl.mmio.component_register.memcache_register.hdm_decoder_capability import (
    CxlHdmDecoderCapabilityStructure,
    CxlHdmDecoderCapabilityStructureOptions,
)
from cxl_ecosys.cxl.mmio.component_register.memcache_register import (
    CxlCacheMemRegister,
...
def test_hdm_decoder_capability_commit():
    class_path = "cxl_ecosys.cxl.component.hdm_decoder.DeviceHdmDecoderManager"
