...
from cxl_ecosys.pci.config_space.pcie.doe import DoeStatus
from cxl_ecosys.cxl.config_space.doe.doe import (
    DoeExtendedCapability,
    CxlDoeExtendedCapability,
)
from cxl_ecosys.cxl.config_space.doe.doe_table_access import (
...
from cxl_ecosys.cxl.config_space.doe.cdat import CdatHeader
from cxl_ecosys.pci.config_space.pcie.doe import (
    DOE_REGISTER_OFFSET,
)
from cxl_ecosys.util.number_const import DWORD_BYTES
