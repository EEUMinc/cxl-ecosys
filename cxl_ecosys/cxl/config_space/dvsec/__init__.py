...
from cxl_ecosys.cxl.config_space.dvsec.cxl_extension_dvsec_for_ports import (
    CxlExtensionDvsecForPorts,
    CxlExtensionDvsecForPortsOptions,
)
from cxl_ecosys.cxl.component.cxl_memory_device_component import CxlMemoryDeviceComponent
