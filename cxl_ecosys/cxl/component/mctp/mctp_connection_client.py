...
from cxl_ecosys.cxl.component.mctp.mctp_packet_processor import (
    MctpPacketProcessor,
...
class MctpConnectionClient(RunnableComponent):
    ...
    async def _run(self):
        ...
        if self._auto_reconnect:
            logger.info(self._create_message("Enabled auto-reconnect"))
        ...
        while self._running:
            try:
                ...
                if not self._packet_processor:
                    logger.warning(self._create_message("Connection attempt failed"))
