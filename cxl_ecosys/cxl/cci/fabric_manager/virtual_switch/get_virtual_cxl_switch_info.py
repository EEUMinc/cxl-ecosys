...
from cxl_ecosys.cxl.component.cci_executor import (
    CciRequest,
    CciResponse,
    CciForegroundCommand,
)
from cxl_ecosys.cxl.cci.common import CCI_FM_API_COMMAND_OPCODE, CCI_RETURN_CODE
    ...
    async def _execute(self, request: CciRequest) -> CciResponse:
        ...
        for vcs_id in request_payload.vcs_id_list:
            ...
            for vppb_id in range(start_vppb, stop_vppb):
                ...
                ppb_info = PpbInfo(vppb_id, binding_status, bound_port_id)
